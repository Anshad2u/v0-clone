...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Build importmap — always include react deps + bootstrap deps
    ...
    // Use jsx: 'preserve' — esbuild passes JSX through unchanged,
    // browser's jsx-runtime (from esm.sh) handles the transformation.
    // This avoids esbuild validating JSX structure, so malformed closing
    // tags generated by the AI don't cause compilation errors.
