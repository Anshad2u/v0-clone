...
export function ChatsClient() {
  const { data, error, isLoading } = useSWR<{ data: ChatSummary[] }>('/api/chats')
          ...
          <>
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">{chats.length} {chats.length === 1 ? 'chat' : 'chats'}</p>
              </div>
              <Link
                href="/"
            ...
            {chats.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating your first chat.</p>
                <div className="mt-6">
                  <Link
                    href="/"
